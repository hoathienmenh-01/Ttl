...
- [x] 17 nhiệm vụ (main, realm, sect, npc, grind) cho Phàm Nhân/Luyện Khí/Trúc Cơ
...
### Inventory & Items
- [x] 19 item templates (vũ khí, giáp, đan dược, thảo dược, quặng, phụ kiện, linh phù)
...
lib/
  db/
    src/schema/       — 13 bảng DB (users, characters, inventory, bosses, missions, chat, sects, market, topup, npcs, skills, dungeons)
...
- **Double-claim protection**: mission claimed → không claim được lại
- **Currency không âm**: bán item không thể để linh thạch âm
- **Realm check**: bí cảnh cần đúng cảnh giới mới vào được

## Việc Còn Lại

- [ ] Skill sử dụng trong combat (hiện tại combat không dùng skill)
- [ ] NPC relationship system (thân thiết, danh tiếng)
- [ ] Daily quest reset mỗi 24h
