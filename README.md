...
- [ ] Active/equipped skill slots và UI chọn skill ưu tiên; combat vẫn phải resolve server-side
- [ ] NPC affinity cooldown/daily talk limit
- [ ] Unlock dialogue/quest flavor theo affinity thresholds
- [ ] Apply Drizzle schema push/preflight trên DB thật trước khi dùng các schema mới
